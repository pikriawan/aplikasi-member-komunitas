                ...
                <div class="flex flex-col lg:items-center bg-black text-white lg:px-4 lg:pb-6">
                    <div class="flex flex-col lg:flex-row w-full lg:max-w-270">
                        <div class="flex flex-col gap-8 p-8 bg-[#121212] relative w-full">
                            ...
                            <div class="flex justify-center items-center w-24 h-24 bg-white">
                                <span class="font-medium text-black">AMK</span>
                            </div>
                            <p class="text-[#999999]">
                                Komunitas ini adalah ruang terbuka bagi siapa saja yang ingin belajar, berkembang, dan saling terhubung dalam lingkungan yang positif dan kolaboratif. Kami menghadirkan berbagai kesempatan untuk bertukar wawasan, membangun relasi, serta berpartisipasi dalam kegiatan yang mendorong pertumbuhan pribadi maupun profesional.
                                <br />
                            ...
                            <div class="flex gap-1">
                                <Link class="bg-[#1A1A1A] flex items-center justify-center p-2" href="#">
                        ...
                        <div class="flex flex-col lg:flex-row w-full">
                            <div class="w-full flex flex-col gap-8 p-8">
                                ...
                                <div class="flex flex-col gap-2">
                                    <Link class="bg-black font-medium" href="#">TENTANG</Link>
                            ...
                            <div class="w-full flex flex-col gap-8 p-8">
                                ...
                                <div class="flex flex-col gap-2 text-[#999999]">
                                    <Link class="flex gap-2" href="#">
                                        ...
                                        Gedung Cipta Karya, Jl. Pahlawan Sejahtera No. 5, Surabaya
                                    </Link>
                                    <Link class="flex gap-2" href="#">
