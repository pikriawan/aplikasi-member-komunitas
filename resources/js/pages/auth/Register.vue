...
<template>
    <HomeLayout>
        ...
        <Form class="flex flex-col items-start gap-3" action="/auth/register" method="post" #default="{ errors }">
            ...
            <p>Sudah punya akun? <Link class="text-blue-600" href="/auth/login">Login sekarang</Link></p>
        </Form>
    </HomeLayout>
</template>
