...
<template>
    <StaffLayout>
        <DashboardHeader title="Edit Profil" :back-href="route('staff.profile.index')">
        ...
        <main class="w-full h-full overflow-auto">
            <Form id="edit_profile" class="flex flex-col gap-8 p-8 lg:min-h-full" :action="route('staff.profile.update')" method="put" v-slot="{ errors }">
