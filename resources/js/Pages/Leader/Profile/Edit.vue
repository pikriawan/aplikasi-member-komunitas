...
<template>
    <LeaderLayout>
        <DashboardHeader title="Edit Profil" :back-href="route('leader.profile.index')">
        ...
        <main class="w-full h-full overflow-auto">
            <Form id="edit_profile" class="flex flex-col gap-8 p-8 lg:min-h-full" :action="route('leader.profile.update')" method="put" v-slot="{ errors }">
