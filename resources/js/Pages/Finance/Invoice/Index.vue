                            ...
                            <table class="min-w-full">
                                <thead class="bg-onyx-50 rounded-lg">
                                    <tr class="border-b border-onyx-200">
                                        ...
                                        <th class="whitespace-nowrap p-4 text-start font-semibold">Diverifikasi oleh</th>
                                ...
                                <tbody>
                                    <tr v-for="invoice in invoices.data" :key="invoice.id">
                                        ...
                                        <td class="whitespace-nowrap p-4 align-middle">{{ invoice.user.name }}</td>
