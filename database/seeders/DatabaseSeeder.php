    ...
    public function run(): void
    {
        ...
        $messages = [
            [
                ...
                'content'           => 'Bagaimana cara memperbarui data profil saya?',
            ],
            [
                'senderId'          => $staff->id,
                'conversationId'    => $conversations[0]->id,
                'content'           => 'Masuk ke akun Anda, lalu buka menu Profil. Pilih Edit Profil, kemudian ubah data yang diinginkan seperti foto, alamat, atau nomor kontak. Setelah selesai klik Simpan.',
            ],
            [
                'senderId'          => $member->id,
                'conversationId'    => $conversations[1]->id,
                'content'           => 'Apakah data anggota aman di dalam aplikasi?',
            ]
        ];
